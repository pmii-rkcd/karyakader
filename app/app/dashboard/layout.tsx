...
import { Menu, X, FileText, CalendarDays, Users, LayoutTemplate, PanelRight, Building, Home, LogOut, UserCheck, BarChart3 } from 'lucide-react';
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    // 🔥 MENU BARU STATISTIK PENGUNJUNG 🔥
    { name: 'Statistik Pengunjung', path: '/dashboard/statistik', icon: BarChart3 },
